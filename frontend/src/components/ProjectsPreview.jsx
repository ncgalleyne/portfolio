...
function ProjectCard({ project }) {
  return (
    <div className="group relative w-full rounded overflow-hidden bg-container-low">
      ...
      {project.cloudinaryImgUrl ? (
        <img src={project.cloudinaryImgUrl} alt={project.title} className="w-full h-full object-cover" />
      ) : (
      ...
      {/* Overlay on hover */}
      <div className="absolute inset-0 bg-gradient-to-t from-container-lowest via-container-lowest/80 to-transparent
